...
export const Definitions = {
  ...
  session_side_chat: keybind("<leader>j", "Toggle side chat"),
  session_side_chat_new: keybind("<leader>k", "New side chat"),
  session_side_chat_maximize: keybind("<leader>z", "Maximize side chat"),
...
export const CommandMap = {
  ...
  session_side_chat: "session.side_chat",
  session_side_chat_new: "session.side_chat.new",
  session_side_chat_maximize: "session.side_chat.maximize",
